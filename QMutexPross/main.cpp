...
void ticketsllers::salefunc()
{
    ...
    while(true)
    {
        ...
        QThread::msleep(50);  // 锁外延迟，让其他线程有机会
    }
}
...
int main(int argc, char *argv[])
{
    ...
    seller2.metx = &mtx;
    seller2.sellersname = "seller Duo";
    //将对象移动到线程
    ...
    QObject::connect(&th1, &QThread::started, &seller1, &ticketsllers::salefunc, Qt::QueuedConnection);
    QObject::connect(&th2, &QThread::started, &seller2, &ticketsllers::salefunc, Qt::QueuedConnection);
    QObject::connect(&th3, &QThread::started, &seller3, &ticketsllers::salefunc, Qt::QueuedConnection);
